...
class PaleteTeachers extends StatefulWidget {
  final String cuTitel;
  const PaleteTeachers({super.key, required this.cuTitel});

  @override
  State<PaleteTeachers> createState() => _PaleteUsersState();
}

class _PaleteUsersState extends State<PaleteTeachers> {
      ...
      child: FutureBuilder<List<QueryDocumentSnapshot>>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.isEmpty) {
            return const Center(child: Text("لا يوجد Teacher"));
          }
